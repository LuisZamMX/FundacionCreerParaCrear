...
<body class="d-flex flex-column h-100">
	...
	<main role="main" class="flex-shrink-0">
		...
		<div class="container no-scroll">
            ...
            <h1 class="h1 text-center mb-5">Plan de acción (PDF)</h1>

            <iframe class="w-100" src="mostrarArchivos.php?Archivo=PROYECTO.pdf"  height="900px" style="border: none;"></iframe>
