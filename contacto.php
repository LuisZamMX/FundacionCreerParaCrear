      ...
      <div class="contenido">
        ...
        <div class="contact-form">
          ...
          <form id="formContacto" method="post" action="altcorreo.php">
            ...
            <!-- Correo -->
            <div class="input-group mar-top mt-3">
              <div class="input-group-prepend">
            ...
            <!-- Submit -->
            <button type="button" id="enviar" class="btn btn-primary mt-3"><span class="icon-chevron-with-circle-right contacto-icon"></span>Enviar</button>
